...
import 'package:pips/features/project/domain/models/office.dart';
...
class FullProject {
  ...
  FullProject({
    ...
    rapAffectedHouseholds,
        ...
        fsCost = fsCost ?? FsCost(),
        rowCost = rowCost ?? RowCost(),
        rapCost = rapCost ?? RapCost(),
        financialAccomplishment = financialAccomplishment ??
            FinancialAccomplishment(
                nep2023: 0,
                nep2024: 0,
  ...
  FullProject copyWith({
    ...
    rapAffectedHouseholds,
      ...
      FullProject(
        ...
        rowCost: rowCost ?? this.rowCost,
        rapCost: rapCost ?? this.rapCost,
        rowAffectedHouseholds:
            rowAffectedHouseholds ?? this.rowAffectedHouseholds,
        rapAffectedHouseholds:
            rapAffectedHouseholds ?? this.rapAffectedHouseholds,
      );
}
  ...
  FsInvestment copyWith({
    ...
    double? y2029,
      ...
      FsInvestment(
        ...
        y2022: y2022 ?? this.y2022,
        y2023: y2023 ?? this.y2023,
        y2024: y2024 ?? this.y2024,
        y2025: y2025 ?? this.y2025,
        y2026: y2026 ?? this.y2026,
        y2027: y2027 ?? this.y2027,
        y2028: y2028 ?? this.y2028,
        y2029: y2029 ?? this.y2029,
      );
...
class FsCost {
  ...
  FsCost(
      {num? y2023, num? y2024, num? y2025, num? y2026, num? y2027, num? y2028});

  factory FsCost.fromJson(Map<String, dynamic> json) => _$FsCostFromJson(json);

  Map<String, dynamic> toJson() => _$FsCostToJson(this);
...
class RowCost {
  ...
  Map<String, dynamic> toJson() => _$RowCostToJson(this);
...
class RapCost {
  ...
  Map<String, dynamic> toJson() => _$RapCostToJson(this);
